...
const uiURL = process.env.NODE_ENV === 'development' ? process.env.NEXT_PUBLIC_SITE_URL_DEV : NEXT_PUBLIC_SITE_URL_PROD;
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Discuss and share their thoughts or ideas"
        />
